...
from src.agents.research_supervisor.tools import (ConductResearch,
                                                  ResearchComplete,
                                                  think_tool)
...
def supervisor_tools(state: SupervisorState) -> Command[Literal["supervisor", "__end__"]]:
    """
