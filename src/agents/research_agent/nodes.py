...
from src.agents.services import model, compress_model
from src.agents.utils import get_today_str
from src.agents.prompts import (research_agent_prompt,
                                compress_research_system_prompt,
                                compress_research_human_message)
from src.agents.research_agent.tools import tavily_search, think_tool
from src.agents.research_agent.states import ResearcherState
...
def compress_research(state: ResearcherState) -> dict:
    ...
    messages = [SystemMessage(content=system_message)] + [HumanMessage(content=compress_research_human_message.format(research_topic=state.get("researcher_messages", [])))]
